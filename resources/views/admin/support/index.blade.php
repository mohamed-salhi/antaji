        ...
        <div class="page-title">
            <div class="row gutters">
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                    <h5 class="title">@lang('Technical support')</h5>
                </div>
                                    ...
                                    <ul class="users">
                                        ...
                                        @foreach($users as $item)
                                            <li class="person" data-chat="person1">
                                                ...
                                                <button class="name" data-uuid="{{$item->uuid}}"
                                                        data-url="{{route('index',$item->uuid)}}"
                                                        id="user-chat">

                                                </button>
                                                <div class="user">
                                                    <img src="{{$item->image}}" alt="Retail Admin">
                                                    <span class="status busy"></span>
                                                </div>
                                                <p class="name-time">
                                                    <span class="name">{{$item->name}}</span>
                                                    <span
                                                        class="time">{{$item->message[0]->created_at->diffForHumans()}}</span>
                                                    <span class="view{{$item->uuid}}">{{$item->message_count}}</span>
                                                </p>
