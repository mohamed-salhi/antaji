                        ...
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a
                                        href="{{ route('multidaydiscount.index') }}">@lang('multi day discount')</a>
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="head-label">
                                    <h4 class="card-title">@lang('multi day discount')</h4>
                                </div>
                                {{--                                @can('place-create')--}}
    ...
    <div class="modal fade" id="edit_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('multidaydiscount.update') }}" method="POST" id="form_edit" class=""
...
@section('scripts')
    ...
    <script type="text/javascript">
        ...
        var table = $('#datatable').DataTable({
            ...
            ajax: {
                url: '{{ route('multidaydiscount.indexTable', app()->getLocale()) }}',
                // data: function (d) {
...
`;
        ...
        $(document).ready(function () {
            $(document).on('click', '.btn_edit', function (event) {
                ...
                $('#uuid').val(uuid);
                console.log(button.data('rate'))
                $('#edit_rate').val(button.data('rate'))
