                    ...
                    <div class="col-12">
                        ...
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                ...
                                {{--                                </li>--}}
                                <li class="breadcrumb-item"><a href="{{ route('settings.terms_conditions') }}">@lang('settings')</a>
                                </li>
                            </ol>
                        </div>
                    </div>
                                ...
                                <form action="{{route('settings.terms_conditions')}}" method="post">
                                  ...
                                  <div class="row " >
                                      <div class="mr-lg-75">
                                          ...
                                          <textarea id="about_application" class="myTextarea1" name="terms_conditions_ar" >{{@$settings->getTranslation('title', 'ar') }}</textarea>
                                          <div class="invalid-feedback"></div>
                                      </div>

                                      <div class="ml-lg-75">
                                          <h1 class="text-primary">@lang('terms conditions') @lang('English')</h1>
                                          <textarea id="policies_privacy" class="myTextarea3" name="terms_conditions_en">{{@$settings->getTranslation('title', 'en') }}</textarea>
                                          <div class="invalid-feedback"></div>
                                      </div>
                                  </div>
                                    <br>
