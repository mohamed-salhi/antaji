<div class="main-menu menu-fixed menu-accordion menu-shadow menu-dark" data-scroll-to-active="true">
    ...
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            @endcan
            @can('ads')
                <li class="nav-item {{ request()->routeIs('ads.index') ? 'active' : '' }}" style="">
                    <a class="d-flex align-items-center" href="{{ route('ads.index') }}">
                        <i class="fa fa-headphones" style="font-size:20px">
                        </i> <span class="menu-title text-truncate"
                                   data-i18n="Charts">@lang('ads')</span></a>
                </li>
            @endcan
            @can('location')
            ...
            @endcan
{{--            @can('conversation')--}}
{{--                <li class="nav-item {{ request()->routeIs('conversations.index') ? 'active' : '' }} ">--}}
{{--                    <a class="d-flex align-items-center" href="{{ route('conversations.index') }}">--}}
{{--                        <i class="fas fa-comment	" style="font-size:20px">--}}
{{--                        </i>--}}
{{--                        <span class="menu-title text-truncate"--}}
{{--                              data-i18n="Charts">@lang('Conversations')--}}
{{--                    </span>--}}
{{--                    </a>--}}
{{--                </li>--}}
...
{{--            @endcan--}}
            @can('document')
                <li class="nav-item {{ request()->routeIs('documentations.index') ? 'active' : '' }} ">
                    <a class="d-flex align-items-center" href="{{ route('documentations.index') }}">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                             class="bi bi-boxes" viewBox="0 0 16 16">
                            <path
                                d="M7.752.066a.5.5 0 0 1 .496 0l3.75 2.143a.5.5 0 0 1 .252.434v3.995l3.498 2A.5.5 0 0 1 16 9.07v4.286a.5.5 0 0 1-.252.434l-3.75 2.143a.5.5 0 0 1-.496 0l-3.502-2-3.502 2.001a.5.5 0 0 1-.496 0l-3.75-2.143A.5.5 0 0 1 0 13.357V9.071a.5.5 0 0 1 .252-.434L3.75 6.638V2.643a.5.5 0 0 1 .252-.434L7.752.066ZM4.25 7.504 1.508 9.071l2.742 1.567 2.742-1.567L4.25 7.504ZM7.5 9.933l-2.75 1.571v3.134l2.75-1.571V9.933Zm1 3.134 2.75 1.571v-3.134L8.5 9.933v3.134Zm.508-3.996 2.742 1.567 2.742-1.567-2.742-1.567-2.742 1.567Zm2.242-2.433V3.504L8.5 5.076V8.21l2.75-1.572ZM7.5 8.21V5.076L4.75 3.504v3.134L7.5 8.21ZM5.258 2.643 8 4.21l2.742-1.567L8 1.076 5.258 2.643ZM15 9.933l-2.75 1.571v3.134L15 13.067V9.933ZM3.75 14.638v-3.134L1 9.933v3.134l2.75 1.571Z"/>
                        ...
                        <span class="menu-title text-truncate"
                              data-i18n="Charts">@lang('documentation')
                    </span>
                    </a>
                </li>
                    ...
                    <ul class="menu-content">
                        ...
                        <li class="nav-item {{ request()->routeIs('payments.index') ? 'active' : '' }} ">
                            <a class="d-flex align-items-center" href="{{ route('payments.index') }}">
                                <i data-feather="file-text"></i><span
                                    class="menu-title text-truncate">@lang('Payments')</span>
                            </a>
                        </li>
                    </ul>
                </li>
...
" style="font-size:20px">
                        ...
                        <span
                            class="menu-title text-truncate">@lang('Technical_support')</span>
                    </a>
                </li>
            ...
            @can('notification')
                <li class="nav-item {{ request()->routeIs('notifications.index') ? 'active' : '' }} ">
                    <a class="d-flex align-items-center" href="{{ route('notifications.index') }}">
                        <i data-feather="file-text"></i><span
                            class="menu-title text-truncate">@lang('notifications')</span>
                    </a>
                </li>
            ...
            @can('discount')
                <li class="nav-item has-sub  " style="">
                    ...
                    <ul class="menu-content">
                        ...
                        <li class="nav-item {{ request()->routeIs('delivery.index') ? 'active' : '' }} ">
                            <a class="d-flex align-items-center" href="{{ route('delivery.index') }}">
                                <i data-feather="file-text"></i><span
                                    class="menu-title text-truncate">@lang('delivery')</span>
                            </a>
                        </li>
                    </ul>
                </li>
            ...
            @endcan
            @can('social')
                <li class="nav-item {{ request()->routeIs('social.index') ? 'active' : '' }}" style="">
                    <a class="d-flex align-items-center" href="{{ route('social.index') }}">
                        ...
                        <span class="menu-title text-truncate"
                              data-i18n="Charts">@lang('social media sites')</span></a>
                </li>
            @endcan
        </ul>
    </div>
