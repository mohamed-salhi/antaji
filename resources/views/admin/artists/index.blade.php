        ...
        <div class="content-header row">
            <div class="content-header-left col-md-9 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h2 class="content-header-title float-left mb-0">@lang('artists')</h2>
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{ route('artists.index') }}">@lang('home')</a>
                                </li>
                                <li class="breadcrumb-item"><a href="{{ route('artists.index') }}">@lang('artists')</a>
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="head-label">
                                    <h4 class="card-title">@lang('artists')</h4>
                                </div>
    ...
    <div class="modal fade" class="full-modal-stem" id="full-modal-stem" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('artists.store') }}" method="POST" id="add-mode-form" class="add-mode-form"
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-6">
                                ...
                                <select name="skills[]" class="select" multiple>
    ...
    <div class="modal fade" id="edit_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('artists.update') }}" method="POST" id="form_edit" class="form_edit"
                      enctype="multipart/form-data">
                    @csrf
...
@section('scripts')
    ...
    <script type="text/javascript">
        ...
        var table = $('#datatable').DataTable({
            ...
            ajax: {
                url: '{{ route('artists.indexTable', app()->getLocale()) }}',
                data: function (d) {
...
`;
    ...
    <script>
        $('select[name="country_uuid"]').on('change', function () {
            ...
            if (country_uuid) {
                $.ajax({
                    url: "artists/country" + "/" + country_uuid,
                    type: "GET",
                    dataType: "json",
