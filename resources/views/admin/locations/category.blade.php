    ...
    <div class="modal fade" class="full-modal-stem" id="full-modal-stem" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('locations.categories.store') }}" method="POST" id="add-mode-form" class="add-mode-form"
    ...
    <div class="modal fade" id="edit_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('locations.categories.update') }}" method="POST" id="form_edit" class=""
                      enctype="multipart/form-data">
                    @csrf
...
@section('scripts')
    ...
    <script type="text/javascript">
        ...
        var table = $('#datatable').DataTable({
            ...
            ajax: {
                url: '{{ route('locations.categories.indexTable', app()->getLocale()) }}',
                data: function (d) {
